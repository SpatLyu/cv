...
<p style="font-size: 0.85em; font-style: italic; color: #555;">
Note: "Lyu, W." and "Lv, W." are both used by the author, Wenbo Lyu.
</p>
...
tibble::tribble(
  ...
  "First Author", "Accepted by CEUS, currently in production",
  ...
  # "First Author", "Submitted to Sci.Adv, currently under evaluation",
  "Spatial Pattern Entropy: A Symbolic Measure for Continuous Spatial Data",
  "Co-First Author", "Submitted to IJGIS, currently under review",
  "Unveiling interaction between spatial processes with information decomposition",
  "First Author", "Plan",
  "pc: An R Package for Causal Discovery via Pattern Causality Analysis",
  "First Author", "Plan",
