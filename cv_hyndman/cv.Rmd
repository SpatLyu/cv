...
tribble(
  ~ Name, ~ Role, ~ Status,
  "gdverse: An R package for spatial stratified heterogeneity family", "First Author", "Submitted to TGIS, currently under revision",
...
| sshicm        | Information Consistency-Based Measures for Spatial Stratified Heterogeneity | <https://github.com/stscl/sshicm>        | C++, R         |
