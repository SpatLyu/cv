...
tribble(
  ~ Name, ~ Role, ~ Status,
  "Measuring causal associations by geographical cross mapping cardinality", "First Author", "Submitted to Science Bulletin",
  ...
  "An Entropy-Based Measure of Spatial Association", 
